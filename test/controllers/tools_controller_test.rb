...
class ToolsControllerTest < ActionController::TestCase
  ...
  test "should create tool" do
    assert_difference('Tool.count') do
      post :create, tool: { content_block_id: @tool.content_block_id, name: @tool.name, url: @tool.url }
    end
  ...
  test "should update tool" do
    patch :update, id: @tool, tool: { content_block_id: @tool.content_block_id, name: @tool.name, url: @tool.url }
    assert_redirected_to tool_path(assigns(:tool))
  end
